...
if __name__ == "__main__":
    ...
    # main("1.0", "https://dummytask7.herokuapp.com/data", sp['login_username'], sp['login_pw'])


    # fetch("https://dummytask7.herokuapp.com/data", "trialdata", "1.0", )

    

    # requests.get(os.path.join("https://dummytask7.herokuapp.com/data", "trialdata", "1.0"), HTTPBasicAuth(username, password))

    os.path.join("https://dummytask7.herokuapp.com/data", "trialdata", "1.0")
